 ...
 * `public/privacidade.php` siga o histórico DESTE arquivo: mexer em SEO,
 * layout ou navegação da página não anuncia atualização do documento, e mexer
 * no texto sempre anuncia. Ver `legal_updated_at()` em `helpers.php` e
