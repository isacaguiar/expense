...
describe('PaymentsEntry', () => {
  beforeEach(() => {
    navigateMock.mockClear();
    vi.mocked(axios.get).mockReset();
  });

  it('redirects to the most active group\'s payments screen', async () => {
    ...
    await waitFor(() => {
      expect(navigateMock).toHaveBeenCalledWith('/groups/2/payments', { replace: true });
    });
  });
