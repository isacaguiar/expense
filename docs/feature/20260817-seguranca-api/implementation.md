...
|---|---|---|---|---|
| TASK-011 | Commitado localmente (`f493b73c`), aguardando decisão de push/PR | 2026-08-17 | `backend/TASK-011-pix-auth` | Ver checklist abaixo. |
| TASK-012 | Commitado localmente (`8dbcfa63`), aguardando decisão de push/PR | 2026-08-17 | `backend/TASK-012-group-membership` | Ver checklist abaixo. |
| TASK-015 | Commitado localmente (`85574859`), aguardando decisão de push/PR | 2026-08-17 | `backend/TASK-015-no-plaintext-log` | Ver checklist abaixo. |
