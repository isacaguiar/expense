...
| TASK-016 | Implementada, aguardando PR feature → `dev` | 2026-08-21 | `backend/20260817-seguranca-api` | Achado tangencial durante `docs/feature/20260820-melhoria-tela-grupos/`; feature reaberta seguindo o fluxo atual (ADR-003). Ver checklist abaixo. |
