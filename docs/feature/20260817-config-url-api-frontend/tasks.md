...
|---|---|---|---|---|---|
| TASK-027 | Introduzir `VITE_API_BASE_URL` (`frontend/src/config.ts` + `.env`/`.env.example`) e substituir a URL da API hardcoded em todas as chamadas de `frontend/src/pages` e em `frontend/src/api.ts` | frontend | plan.md §1 | nenhum | Pendente |
