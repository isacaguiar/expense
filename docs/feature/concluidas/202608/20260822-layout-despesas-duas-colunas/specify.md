...
- Redesenho de navegação global (sidebar) ou rebrand visual — já fora de escopo nas duas features anteriores desta mesma tela/família (`docs/feature/concluidas/202608/20260818-resumo-grupo-dashboard/specify.md` §4, `docs/feature/concluidas/202608/20260822-reestruturacao-resumo/specify.md` §4) e não reaberto aqui.
