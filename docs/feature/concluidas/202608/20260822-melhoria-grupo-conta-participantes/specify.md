...
- Qualquer alteração ao menu lateral além de apontar o link "Meus Grupos" para a nova URL (§2.1) — o posicionamento do item dentro de "Configurações" já foi resolvido pela feature `docs/feature/concluidas/202608/20260820-melhoria-tela-grupos` e não muda aqui.
