...
> Formato igual ao usado no SDD geral — ver `docs/sdd/03-tasks.md` para a definição completa do formato e a regra de atomicidade ("se a descrição tem 'e' ligando duas entregas independentes, é duas tasks"). IDs a partir de `TASK-102` — maior ID já usado no projeto antes desta feature: `TASK-101` (`docs/feature/concluidas/202608/20260820-atualizacao-layout-paginas/tasks.md`).
