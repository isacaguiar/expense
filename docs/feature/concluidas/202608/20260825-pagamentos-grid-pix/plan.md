...
- `Payments.tsx` envolve o retorno com `DespesasThemeScope` (mesmo componente de `docs/feature/concluidas/202608/20260825-redesign-visual-despesas/`, sem alteração nele) — reaproveita o tema já existente, sem criar um tema novo.
