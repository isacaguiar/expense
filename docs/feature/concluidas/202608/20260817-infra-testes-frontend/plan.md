...
- Dois casos, direto dos critérios de aceite já validados manualmente na TASK-028 (`docs/feature/concluidas/202608/20260817-config-url-api-frontend/tasks.md`): sem token, a rota pública (login) é o que renderiza; com token presente, o conteúdo protegido renderiza.
