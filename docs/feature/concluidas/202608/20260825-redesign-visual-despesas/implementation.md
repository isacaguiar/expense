...
- Igual ao precedente de `docs/feature/concluidas/202608/20260822-criacao-tela-pagamentos/implementation.md`: todas as tasks são implementadas direto na branch da feature (`frontend/20260825-redesign-visual-despesas`), sem sub-branch por task.
