...
| TASK-005 | Aplicar `UserAvatar` no diálogo Pix de Pagamentos e no formulário de Entrada (`ExpenseForm.tsx`, `ExpenseView.tsx`) | frontend | plan.md §5 | antes do merge | Concluída |
