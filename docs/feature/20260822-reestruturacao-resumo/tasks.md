...
| TASK-002 | Criar `SummarySidePanel.tsx` com abas Saldo/À pagar (reaproveitando `BalanceCards`/`SettlementList`) e integrar em `GroupSummary.tsx` | frontend | plan.md §2 | nenhum | Pendente |
