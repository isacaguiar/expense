...
- Simplificação multilateral de dívida ou qualquer mudança na lógica de liquidação par-a-par — já definida como fora de escopo em `docs/feature/20260822-acerto-de-contas-ciclo/specify.md` §"Fora de escopo" e não reaberta aqui.
...
- Redesenho de navegação global (sidebar) ou rebrand visual (paleta, logo) — já marcados fora de escopo em `docs/feature/20260818-resumo-grupo-dashboard/specify.md` §4 e não reabertos aqui.
