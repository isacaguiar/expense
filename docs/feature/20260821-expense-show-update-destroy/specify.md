...
> Feature: implementar `ExpenseController::show/update/destroy`, hoje ausentes apesar de as rotas já estarem registradas via `apiResource`. Promovida do item 023 do backlog (`docs/backlog/expense-show-update-destroy-ausentes.md`), origem `docs/feature/20260820-atualizacao-layout-paginas/specify.md`.
