...
- Qualquer mudança em `GroupExpenseReportController` (endpoint legado por ano/mês calendário) — permanece como está, sem uso, conforme já decidido em `docs/feature/20260822-acerto-de-contas-ciclo/specify.md` §4.
