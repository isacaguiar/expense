...
| TASK-351 | `Dashboard.tsx` consome `max_groups_per_user` da API em vez de constante hardcoded | frontend | plan.md §2 | nenhum | Pendente |
| TASK-352 | Teste que prova o botão de criar grupo reagindo ao limite vindo da API (e não travando antes de carregar) | frontend | plan.md §2 | nenhum | Pendente |
