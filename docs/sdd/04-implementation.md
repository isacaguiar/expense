...
3. **Checklist antes de abrir PR**:
   ...
   - [ ] Backend: `./vendor/bin/pint` limpo; teste PHPUnit novo/atualizado se a task mexeu em regra de negócio (Constitution §2.2).
   - [ ] Frontend: `tsc` sem erro, sem `any` não justificado.
