...
| [20260921-google-logs-temporarios.md](20260921-google-logs-temporarios.md) | Logs de diagnóstico temporários ativos em produção no callback do Google | 2026-09-21 | `fix/20260921-google-logs-temporarios` | Aberto |
