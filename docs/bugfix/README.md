...
| [20260920-agents-md-caminho-codex.md](20260920-agents-md-caminho-codex.md) | Caminho dos agents no `AGENTS.md` com caixa errada (`.Codex/agents/`) | 2026-09-20 | `fix/20260920-agents-md-caminho-codex` | Aberto |
