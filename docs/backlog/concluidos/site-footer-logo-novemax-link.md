...
Prioridade: BAIXA
Status: Promovido para TASK-292
...
Feature: docs/feature/concluidas/202609/20260919-logo-novemax-rodape-site/ (migra para lá quando o PR mergear em `dev` — ADR-009; enquanto isso, está em `docs/feature/concluidas/202609/20260919-logo-novemax-rodape-site/`)
