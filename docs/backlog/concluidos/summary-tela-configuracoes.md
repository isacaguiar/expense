...
ID: 019
Origem: docs/feature/concluidas/202608/20260819-novo-layout-tela-entrada/specify.md §2.3/R2 (item "Configurações" da sidebar como placeholder `href="#"`)
Criado em: 2026-08-19
Prioridade: BAIXA
Status: Fechado sem promoção — ver nota 2026-08-26 e Resolução
...
Sem promoção para feature/TASK — a única necessidade concreta que o item registrava (campo "Dia de fechamento" editável após a criação do grupo) já foi resolvida por `GroupForm.tsx` na feature `20260821-melhoria-menu-tela-grupos-perfil`, antes mesmo deste item ser revisado. O que sobrava era escopo genérico ("outras configurações que o mockup sugere"), sem necessidade concreta — reabrir só quando houver uma configuração específica nova a adicionar.
