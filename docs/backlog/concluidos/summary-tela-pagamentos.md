...
ID: 017
Origem: docs/feature/concluidas/202608/20260819-novo-layout-tela-entrada/specify.md §2.3/R2 (item "Pagamentos" da sidebar como placeholder `href="#"`)
...
Sem isso, o item "Pagamentos" da sidebar fica como promessa visual não cumprida. Depende de decisão de produto sobre o escopo exato (relaciona-se com o achado 2.6 do `specify.md` de `docs/feature/concluidas/202608/20260818-resumo-grupo-dashboard/`, sobre não existir endpoint para marcar `Quota.paid`).
...
Feature: docs/feature/concluidas/202608/20260822-criacao-tela-pagamentos/ (tela dedicada `/groups/:id/payments` + `PaymentsEntry`, lista de despesas por competência, confirmação de pagamento com foto de comprovante) e docs/feature/concluidas/202608/20260825-pagamentos-grid-pix/ (layout em grid, Pix QR Code + copia-e-cola, confirmação de settlement pelo devedor)
