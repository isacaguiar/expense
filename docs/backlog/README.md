...
| 012 | [expense-manager-installments-nao-projetadas-por-mes.md](expense-manager-installments-nao-projetadas-por-mes.md) | Despesas Parceladas não aparecem nos meses seguintes ao de criação, e valor exibido é o total, não a parcela | resumo-grupo-dashboard | 2026-08-18 | MEDIA | Promovido para TASK-132 |
| 013 | [expense-manager-data-exibida-com-um-dia-a-menos.md](expense-manager-data-exibida-com-um-dia-a-menos.md) | ExpenseManager exibe a data das despesas com 1 dia a menos em fusos negativos | resumo-grupo-dashboard (achado na TASK-063) | 2026-08-19 | MEDIA | Promovido para TASK-133 |
