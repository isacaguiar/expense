...
| 048 | [site-consentimento-cookies-analytics.md](site-consentimento-cookies-analytics.md) | Google Analytics do site carrega sem consentimento (LGPD) | site-conteudo-e-precos | 2026-09-20 | MEDIA | Promovido para TASK-309 |
